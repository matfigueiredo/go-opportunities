...
- `make build`: Build the application and create an executable file named `go-opportunities`.
- `make test`: Run tests for all packages in the project.
- `make docs`: Generate the API documentation using Swag.
- `make clean`: Remove the `go-opportunities` executable and delete the `./docs` directory.
